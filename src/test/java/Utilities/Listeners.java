...
public class Listeners implements ITestListener {
    ...
    public void onTestStart(ITestResult result) {
        System.out.println("onTestStart - Her bir @Testden önce tek bir kere cagrilir : "+result.getName());
    }
    ...
    public void onTestSkipped(ITestResult result) {
        System.out.println("onTestSkipped - Sadece SKIP olan testlerden SONRA tek bir kez cagrilir : "+result.getName());
    }
}

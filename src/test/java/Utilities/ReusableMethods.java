...
//             document.querySelector("#example").value; -> CSS DEGERI KULLANILABILIR
    ...
    //--------------- select dropdown with text -------------
    public static void selecDropdownWithText(WebElement dropdown, String text) {
    ...
    //--------------- dropdown select------------------
    public static Select selectDropdown(WebElement dropdown) {
        WebElement select = dropdown;
        Select selectDropdown = new Select(select);
...
//            V TUSUNA BAS
    ...
    public static void hoverWithTimeOut(WebElement element, int timeout) {
        for (int i = 0; i < timeout; i++) {
            try {
                hover(element);
                return;
